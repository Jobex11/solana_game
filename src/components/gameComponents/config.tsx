...
export const DINO = {
    statusInfo: {
        [PlayerState.STAND]: {
            frames: [
                {
                    canvasType: CanvasType.CAT_STAND,
        ...
        [PlayerState.RUN]: {
            frames: [
                {
                    canvasType: CanvasType.CAT_RUN_1,
                    colliderType: ColliderType.DINO_RUN_1,
                },
                {
                    canvasType: CanvasType.CAT_RUN_2,
        ...
        [PlayerState.ATTACK]: {
            frames: [
                {
                    canvasType: CanvasType.CAT_ATTACK_1,
                    colliderType: ColliderType.DINO_RUN_1,
                },
                {
                    canvasType: CanvasType.CAT_ATTACK_4,
                    colliderType: ColliderType.DINO_RUN_2,
                }
            ],
            frameSeconds: 8,
        ...
        [PlayerState.DUCK]: {
            frames: [
                {
                    canvasType: CanvasType.CAT_DUCK_1,
                    colliderType: ColliderType.DINO_DUCK_1,
                },
                {
                    canvasType: CanvasType.CAT_DUCK_2,
